...
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "ShasaSupport_Official")
PROJECT_NAME = getenv("PROJECT_NAME", "ShasaMusic v5")
SOURCE_CODE = getenv("SOURCE_CODE", "github.com/TeamShasa/ShasaMusic")
